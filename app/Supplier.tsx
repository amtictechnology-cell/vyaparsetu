        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <View>
                    ...
                    <Text style={styles.businessName}>{profile?.businessName || "Supplier Dashboard"}</Text>
            ...
            <View style={styles.content}>
                <Ionicons name="cube" size={80} color="#0c831f" />
                <Text style={styles.message}>This component opened because you selected 'Supplier' as your business category.</Text>
