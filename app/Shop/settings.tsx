                ...
                if (planString) {
                    ...
                    if (isSub === "true") {
                        const fallbackPlan = {
                            planId: "PLNSILVER",
                            name: "Active Plan",
                            category: currentProfile?.businessCategory || "shop",
                            price: 199,
                            durationInDays: 30,
                ...
                <View style={styles.hotelBanner}>
                    <View style={styles.bannerRow}>
                        <View style={styles.avatarContainer}>
                            <Ionicons name="storefront" size={28} color="#ff6600" />
                        </View>
                        <View style={styles.profileDetails}>
                            <Text style={styles.businessName}>{profile?.businessName || "Your Business"}</Text>
                            <Text style={styles.categoryBadge}>{(profile?.businessCategory || "Shop").toUpperCase()}</Text>
                        </View>
