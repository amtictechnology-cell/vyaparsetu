    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                <Ionicons name="print-outline" size={80} color="#0c831f" />
                <Text style={styles.message}>{"This component opened because you selected 'Printing' as your business category."}</Text>
